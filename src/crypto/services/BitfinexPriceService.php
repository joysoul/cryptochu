 ...
 */
class BitfinexPriceService implements PriceServiceContract
{
    /**
     * URL constants.
     */
    const BASE_URL = 'https://api.bitfinex.com/v1/pubticker/%susd';
    ...
    public function getAsk(CryptoCurrency $cryptoCurrency): MoneyAmount
    {
        ...
        $this->loggerService->info(__CLASS__ . '.' .  __FUNCTION__, [
    ...
    public function getBid(CryptoCurrency $cryptoCurrency): MoneyAmount
    {
        ...
        $this->loggerService->info('Bitfinex ' .  __FUNCTION__, [
